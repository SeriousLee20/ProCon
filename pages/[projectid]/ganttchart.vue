...
export default defineComponent({
  ...
  setup() {
    ...
    const chartData = ref({
      datasets: [{
        data: [{
          x: ['2023-09-12', '2023-10-20'], y: 'Create Poster', name: 'Amber - Program', status: 2
        },
        {
          x: ['2023-10-24', '2023-12-15'], y: 'Print Banner', name: 'Amber - Program', status: 1
        },
        {
          x: ['2023-12-07', '2023-12-14'], y: 'This is a new Task', name: 'Amber - Program', status: 1
        },
        {
          x: ['2023-10-24', '2023-11-04'], y: 'Clean Apparatus', name: 'Amber - Program', status: 2
        },
        {
          x: ['2023-09-15', '2023-11-25'], y: 'Prepare floor plan', name: 'Amber - Program', status: 1
        }
        ],
        backgroundColor: (ctx) => {
