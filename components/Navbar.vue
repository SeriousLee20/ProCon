<template>
  <div class="bg-bluegray-200 grid px-2 pt-1">
    ...
    <div class="col flex justify-content-end align-content-center gap-1">
      ...
      <Poverlay-panel ref="guidePanel" appendTo="body" style="width: 36rem; height: 40rem">
        <Pcarousel :value="steps" :numVisible="1" :numScroll="1" circular>
          <template #item="slotProps">
            <div class="border-1 surface-border border-round m-2 text-center py-5 px-3">
              <div class="mb-3">
                <nuxt-img :src="`/${slotProps.data.image}`" :alt="slotProps.data.name" class="shadow-2"
                  :width="slotProps.data.width" :height="slotProps.data.height" />
              </div>
              <div>
