                    ...
                    <div class="">
                        ...
                        <div class="flex gap-1">
                            <Ptag v-if="slotProps.data?.status" :value="slotProps.data?.status" rounded
                                :icon="slotProps.data?.status_icon" :severity="slotProps.data?.status_severity"
                                class="max-h-1rem" />
                            <Ptag v-if="slotProps.data?.due_date_time" :value="formatDate(slotProps.data?.due_date_time)"
                                rounded icon="pi pi-stopwatch" class="max-h-1rem" />
